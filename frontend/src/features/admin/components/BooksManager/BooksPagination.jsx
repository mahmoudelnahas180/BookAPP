...
export default function BooksPagination({
  ...
  const endRange = Math.min(page * limit, numberOfBook);

  return (
    <div className="px-6 py-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
      <span className="text-sm text-slate-500 dark:text-slate-400 font-display">
        عرض {startRange}-{endRange} من أصل {numberOfBook} كتاب
      </span>
