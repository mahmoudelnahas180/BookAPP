...
export default function Signup() {
  return (
    <div
      className="bg-background-light font-display text-text-main antialiased min-h-screen flex flex-col relative overflow-hidden transition-colors duration-300"
      dir="rtl"
    >
          ...
          <div className="bg-surface-light rounded-2xl shadow-soft border border-gray-100 p-8 md:p-10 relative overflow-hidden">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-text-muted text-base">
                أنشئ حسابك الجديد وابدأ رحلتك المعرفية اليوم
              </p>
            </div>
            ...
            <div className="mt-8 text-center animate-fade-in-up">
              <p className="text-text-muted">
                ...
                <Link
                  to="/login"
                  className="text-primary font-bold hover:text-primary-hover hover:underline underline-offset-4 transition-all"
                >
                  تسجيل الدخول
                </Link>
              </p>
